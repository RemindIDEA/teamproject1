    ...
    <div class="findid border border-warning">
        ...
        <form action="#">
            <div class="form-group findidgroup">
                ...
                <input type="text" class="form-control findidform border border-warning" placeholder="이메일을 입력하세요"
                    id="email">
            </div>

            <br>
            <button type="submit" class="btn btn-primary border border-warning  findidbtn">아이디찾기</button>
            <button type="submit" class="btn btn-primary border border-warning  findidcancelbtn">취소</button>
        </form>
    </div>
</body>
